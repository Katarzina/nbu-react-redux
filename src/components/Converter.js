...
class Converter extends Component {
    ...
    render() {
        ...
        return (
            <div>
            <form className="form-search" onChange={this.onChangeHandler}>
                <input type="text" placeholder="0.00" />
            </form>
            <select name="currency" value={currency} onChange={this.handleChangeCurrency}>
                {currencySelect}
            </select>
            <div id="form_converter_result" className="form_item form_item-result">
                <h4>Результат</h4>
                <p>
                    <input id="currency_exchange" readOnly="readonly" value={ arrayResult[0][2]} size="10" type="text" />
                    <span className="_description">{arrayResult[0][0]}</span>
                    <input id="currency_rate" value={arrayResult[0][1]} size="4" type="text" />
                </p>
                <p>
                    <input id="currency_exchange" readOnly="readonly" value={ arrayResult[1][2]} size="10" type="text" />
                    <span className="_description">{arrayResult[1][0]}</span>
                    <input id="currency_rate" value={arrayResult[1][1]} size="4" type="text" />
                </p>
                <p>
                    <input id="currency_exchange" readOnly="readonly" value={ arrayResult[2][2]} size="10" type="text" />
                    <span className="_description">{arrayResult[2][0]}</span>
                    <input id="currency_rate" value={arrayResult[2][1]} size="4" type="text" />
                </p>
            </div>
            </div>
        )
